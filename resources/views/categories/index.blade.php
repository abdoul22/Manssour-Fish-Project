        ...
        <article class="mb-3">
                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr class="table-active">
                            ...
                            <td><a href="{{route('categories.edit', ["id" => $category->id])}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                        </tr>
                    @endforeach
                    <tr>
                        <th scope="row">3</th>
                        <td colspan="2" class="table-active">Larry the Bird</td>
                        <td colspan="2">Prix Totol</td>
                        <td>200000 MRU</td>
                    </tr>
                </tbody>
            </table>
            <section class="mt-6 grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-8">
                <article style="margin-right: 10px !important;"
                    class="mb-3  mr-3 pr-5 bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200">
                ...
                <article
                    class="mb-3 pr-5 mr-3 bg-white group relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform duration-200">
                    <div class="relative w-full h-80 md:h-64 lg:h-44">
